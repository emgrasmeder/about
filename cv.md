...
I'm a functional programming enthusiast with a background in data science. I'm currently spending my days thinking about genetic programming, game development, and fixing up a rusty old sailboat while I look for a job. I'm comfortable in the role of technical lead and am drawn towards conversations around business goals and product vision, but happiest writing code most of the time. I believe that almost all the times when a tech endeavor fails, it's not because the technology was too complicated but because _people are complicated_. I think it's vital to focus on the humans - from the customers to the development team to management structures. 
